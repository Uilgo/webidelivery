...
import type _ as RowTypes from "./database";
import type _ as RpcTypes from "./rpc";
...
lojas: { Row: RowTypes.Loja; Insert: never; Update: never };
    	...
    	Functions: {
    		...
    		rpc_atualizar_perfil: { Args: RpcTypes.RpcAtualizarPerfilParams; Returns: void };
    		rpc_desativar_perfil: { Args: RpcTypes.RpcDesativarPerfilParams; Returns: void };
    		rpc_criar_empresa: { Args: RpcTypes.RpcCriarEmpresaParams; Returns: string };
    		rpc_atualizar_empresa: { Args: RpcTypes.RpcAtualizarEmpresaParams; Returns: void };
    		rpc_suspender_empresa: { Args: RpcTypes.RpcSuspenderEmpresaParams; Returns: void };
    		rpc_criar_loja: { Args: RpcTypes.RpcCriarLojaParams; Returns: string };
    		rpc_atualizar_loja: { Args: RpcTypes.RpcAtualizarLojaParams; Returns: void };
    		...
    		rpc_atualizar_plano: { Args: RpcTypes.RpcAtualizarPlanoParams; Returns: void };
    		rpc_criar_assinatura: { Args: RpcTypes.RpcCriarAssinaturaParams; Returns: string };
    		rpc_atualizar_assinatura: { Args: RpcTypes.RpcAtualizarAssinaturaParams; Returns: void };
    		...
    		rpc_atualizar_categoria: { Args: RpcTypes.RpcAtualizarCategoriaParams; Returns: void };
    		rpc_reordenar_categorias: { Args: RpcTypes.RpcReordenarCategoriasParams; Returns: void };
    		rpc_soft_delete_categoria: { Args: RpcTypes.RpcSoftDeleteCategoriaParams; Returns: void };
    		rpc_criar_produto: { Args: RpcTypes.RpcCriarProdutoParams; Returns: string };
    		rpc_atualizar_produto: { Args: RpcTypes.RpcAtualizarProdutoParams; Returns: void };
    		rpc_soft_delete_produto: { Args: RpcTypes.RpcSoftDeleteProdutoParams; Returns: void };
    		rpc_criar_variacao: { Args: RpcTypes.RpcCriarVariacaoParams; Returns: string };
    		rpc_atualizar_variacao: { Args: RpcTypes.RpcAtualizarVariacaoParams; Returns: void };
    		rpc_soft_delete_variacao: { Args: RpcTypes.RpcSoftDeleteVariacaoParams; Returns: void };
    		...
    		rpc_atualizar_adicional: { Args: RpcTypes.RpcAtualizarAdicionalParams; Returns: void };
    		...
    		rpc_atualizar_combo: { Args: RpcTypes.RpcAtualizarComboParams; Returns: void };
    		rpc_soft_delete_combo: { Args: RpcTypes.RpcSoftDeleteComboParams; Returns: void };
    		...
    		rpc_soft_delete_promocao: { Args: RpcTypes.RpcSoftDeletePromocaoParams; Returns: void };

    		// -- MARKETING --------------------------------------------------------
    		rpc_criar_banner: { Args: RpcTypes.RpcCriarBannerParams; Returns: string };
    		rpc_atualizar_banner: { Args: RpcTypes.RpcAtualizarBannerParams; Returns: void };
    		rpc_reordenar_banners: { Args: RpcTypes.RpcReordenarBannersParams; Returns: void };
    		rpc_soft_delete_banner: { Args: RpcTypes.RpcSoftDeleteBannerParams; Returns: void };
    		rpc_criar_cupom: { Args: RpcTypes.RpcCriarCupomParams; Returns: string };
    		rpc_atualizar_cupom: { Args: RpcTypes.RpcAtualizarCupomParams; Returns: void };
    		rpc_soft_delete_cupom: { Args: RpcTypes.RpcSoftDeleteCupomParams; Returns: void };
    		rpc_validar_cupom: {
    		...
    		rpc_atualizar_cliente: { Args: RpcTypes.RpcAtualizarClienteParams; Returns: void };
    		rpc_criar_pedido: { Args: RpcTypes.RpcCriarPedidoParams; Returns: string };
    		rpc_atualizar_status_pedido: { Args: RpcTypes.RpcAtualizarStatusPedidoParams; Returns: void };
    		rpc_atribuir_entregador: { Args: RpcTypes.RpcAtribuirEntregadorParams; Returns: void };
    		rpc_criar_avaliacao: { Args: RpcTypes.RpcCriarAvaliacaoParams; Returns: void };

    		// -- LOGÍSTICA --------------------------------------------------------
    		rpc_criar_entregador: { Args: RpcTypes.RpcCriarEntregadorParams; Returns: string };
    		rpc_atualizar_entregador: { Args: RpcTypes.RpcAtualizarEntregadorParams; Returns: void };
    		...
    		rpc_atualizar_ticket: { Args: RpcTypes.RpcAtualizarTicketParams; Returns: void };
    		rpc_atribuir_ticket: { Args: RpcTypes.RpcAtribuirTicketParams; Returns: void };
    		rpc_enviar_mensagem_ticket: { Args: RpcTypes.RpcEnviarMensagemTicketParams; Returns: string };
    		rpc_criar_nota_ticket: { Args: RpcTypes.RpcCriarNotaTicketParams; Returns: void };
    		rpc_responder_csat: { Args: RpcTypes.RpcResponderCsatParams; Returns: void };

    		// -- NOTIFICAÇÕES -----------------------------------------------------
    		rpc_criar_notificacao: { Args: RpcTypes.RpcCriarNotificacaoParams; Returns: string };
    		rpc_marcar_notificacao_lida: { Args: RpcTypes.RpcMarcarNotificacaoLidaParams; Returns: void };
    		rpc_marcar_todas_lidas: { Args: RpcTypes.RpcMarcarTodasLidasParams; Returns: void };
    		rpc_deletar_notificacao: { Args: RpcTypes.RpcDeletarNotificacaoParams; Returns: void };

    		// -- AUDITORIA & LGPD -------------------------------------------------
    		rpc_registrar_audit_log: { Args: RpcTypes.RpcRegistrarAuditLogParams; Returns: void };
    		rpc_registrar_log_loja: { Args: RpcTypes.RpcRegistrarLogLojaParams; Returns: void };
    		...
    		rpc_processar_exclusao: { Args: RpcTypes.RpcProcessarExclusaoParams; Returns: void };
